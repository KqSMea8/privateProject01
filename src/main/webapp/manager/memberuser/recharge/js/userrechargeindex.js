$(function ($) {
    ...
    var jqGridOption = new Common().createGridOption({
        ...
        sortName: "status",
        sortOrder: "ASC",
        colNamesArray: ['交易记录ID', '申请会员名称', '会员登录帐号', '申请金额', '付款方式', '充值账号', '收款卡号', '收款卡银行名称', '申请时间', '当前状态', '审核人', '审核时间', '审核备注','未转化审核状态'],
        colModel: [{
            name: "deal_id",
            index: "deal_id",
            width: 60,
    ...
    $('#audit').click(function () {
    	...
    	$("#rechargeAccount").text(rowData.recharge_money_account);
    	$("#bankNumber").text(rowData.bank_number);
