...
function createLeafNode(nodeId, parentId, nodeName) {
	var html = "<div id=\"" + CONSTANT_TREENODE + nodeId + "\" parentId=\"" + CONSTANT_TREENODE + parentId + "\" class=\"tree-item\" style=\"display: block;\"><i class=\" ace-icon ace-icon fa fa-check\">&#10004</i><div class=\"tree-item-name\">" + nodeName + "</div></div>";
	return html;
}
