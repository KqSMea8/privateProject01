	...
	.on('hashchange.ajax', function(e, manual_trigger) {
		...
		*/
		...
		if(typeof url === 'string') {
			getUrl(url, hash, manual_trigger || false);
		}
...
var is_element_pos =
	...
	function(el, pos) { if(!el){return 0;} el.offsetHeight; return window.getComputedStyle(el).position == pos }
	:
	function(el, pos) { if(!el){return 0;} el.offsetHeight; return $(el).css('position') == pos }
