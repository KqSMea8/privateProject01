...
public class MoneyUtil {
	...
	public static void main(String[] args) {
		MoneyUtil m = new MoneyUtil();
		  System.out.println(-99999999999999.999+MoneyUtil.NumToRMBStr(-99999999999999.999));
		  System.out.println(99999999999999.999+MoneyUtil.NumToRMBStr(99999999999999.999));
		  System.out.println(MoneyUtil.NumToRMBStr(100000000.06));
		  System.out.println(MoneyUtil.NumToRMBStr(0.03));
